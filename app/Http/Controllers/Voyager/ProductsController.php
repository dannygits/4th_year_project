...
class ProductsController extends VoyagerBaseController
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        return Voyager::view($view, compact('dataType', 'allCategories', 'categoriesForProduct', 'dataTypeContent', 'isModelTranslatable'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if (auth()->user()->can('browse', $model)) {
            ...
            //re-insert if atleast one category is checked
